...
public class order_laptop extends AppCompatActivity {
    EditText prname,name,phone,address;
    Button order,back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_order_laptop);
    ...
    private void processinsert() {
        ...
        FirebaseDatabase.getInstance().getReference().child("Order Laptop").push()
                .setValue(map)
