...
public class adddatalaptop extends AppCompatActivity {
    EditText name,price,purl;
    Button submit,back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_adddatalaptop);
    ...
    private void processinsert()
    {
        ...
        FirebaseDatabase.getInstance().getReference().child("Laptop").push()
                .setValue(map)
